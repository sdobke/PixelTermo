...
<head>
    ...
    <title>PIXELTERMO | Agencia 360°</title>
    <!-- Tailwind CSS -->
...
<body class="antialiased selection:bg-pixel-orange selection:text-white">
    ...
    <section class="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <video autoplay loop muted playsinline class="absolute z-0 w-auto min-w-full min-h-full max-w-none object-cover opacity-40">
            <source src="https://assets.mixkit.co/videos/preview/mixkit-set-of-lights-in-a-stage-loop-32938-large.mp4" type="video/mp4">
        </video>
        <div class="absolute inset-0 overlay z-10"></div>
        
        <div class="relative z-20 text-center px-4">
            <div class="mb-6 inline-block">
                <i class="fa-solid fa-arrow-trend-up text-6xl text-pixel-orange mb-4"></i>
            </div>
    ...
    <section id="stands" class="py-24 bg-pixel-dark">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl md:text-5xl font-black mb-4"><span class="text-pixel-orange">Diseño</span> de Stands</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
                ...
                <div class="order-1 lg:order-2 relative rounded-2xl overflow-hidden shadow-2xl shadow-pixel-orange/20">
                    <!-- Imagen de Stand Gigante (Cámara) -->
                    <img src="https://www.pixeltermo.com.ar/img/stands_1.png" width="2732" height="1536" alt="" Stands" class="w-full h-auto object-cover img-hover-zoom aspect-[4/3]" />
                </div>
				<div class="order-1 lg:order-2 relative rounded-2xl overflow-hidden shadow-2xl shadow-pixel-orange/20">
                    <!-- Imagen de Stand Gigante (Cámara) -->
                    <img src="https://www.pixeltermo.com.ar/img/stands_2.png" width="2732" height="1536" alt="Stands" class="w-full h-auto object-cover img-hover-zoom aspect-[4/3]" />
                </div>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                    <!-- Imagen de Escenario Corporativo -->
                    <img src="https://www.pixeltermo.com.ar/img/stands_3.png" width="2732" height="1536" alt="Stands" class="w-full h-auto object-cover img-hover-zoom aspect-[4/3]">
                </div>
                <div>
                    <h3 class="text-3xl font-bold mb-6">ARQUITECTURA EFÍMERA</h3>
    ...
    <section id="merch" class="py-24 bg-pixel-dark">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="order-2 lg:order-1 relative rounded-2xl overflow-hidden group">
                    <img src="https://images.unsplash.com/photo-1549465220-1a8b9238cd48?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Merchandising" class="w-full h-auto object-cover img-hover-zoom aspect-square md:aspect-[4/3]">
                ...
                <div class="order-1 lg:order-2">
                    ...
                    <div class="flex flex-wrap gap-4 mt-8">
                        <span class="px-4 py-2 border border-white/20 rounded font-bold text-sm">GRAN ENEMIGO</span>
                        <span class="px-4 py-2 border border-white/20 rounded font-bold text-sm">AWS</span>
                        <span class="px-4 py-2 border border-white/20 rounded font-bold text-sm">ANGELICA ZAPATA</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="eventos" class="relative py-32 bg-fixed bg-center bg-cover" style="background-video: url('https://www.pixeltermo.com.ar/videos/eventos.mp4=rb-4.0.3&auto=format&fit=crop&w=1920&q=80');">
    ...
    <section id="contacto" class="py-32 bg-pixel-dark relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div class="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16">
                <!-- WhatsApp -->
                <a href="https://wa.me/5491151744718" target="_blank" class="group flex flex-col items-center gap-4 hover:scale-110 transition-transform">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-semibold group-hover:text-pixel-orange transition-colors">+54 9 11 51744718</p>
                    </div>
                </a>
